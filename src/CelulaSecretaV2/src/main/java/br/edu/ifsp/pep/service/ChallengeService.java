...
public class ChallengeService {
    ...
    public List<ChallengeItem> carregarDesafios() {
        ...
        desafios.add(new ChallengeItem(3,
                ...
                "Mitocôndria",
                List.of("Retículo Endoplasmático", "Mitocôndria", "Ribossomo", "Lisossomo")
        ));
        ...
        desafios.add(new ChallengeItem(13,
                "Assinale a alternativa que contém a organela responsável pela degradação do etanol:",
                "Retículo Endoplasmático Liso",
                List.of("Lisossomo", "Retículo Endoplasmático Liso", "Mitocôndria", "Complexo de Golgi")
        ));
