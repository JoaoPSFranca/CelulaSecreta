...
public class Carta {
    ...
    private boolean celula; // true = célula, false = organismo
    ...
    public Carta(int id, String nome, String descricao, boolean celula, int nivelDificuldade, Reino reino, List<String> propriedades, List<String> funcoes, List<String> organelas) {
        this.id = id;
        this.nome = nome;
    ...
    public List<String> getOrganelas() {
        return organelas;
    }

    public void setOrganelas(List<String> organelas) {
        this.organelas = organelas;
    }
}
